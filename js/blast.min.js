...
$(document).ready(function () {
 $(".blast-box").attr("unselectable", "on").css("user-select", "none").on("selectstart", !1), $(".blast-box .blast-icon").on("click", function () {
  ...
  $(".blast-color").eq(a).css("backgroundColor", $(this).text()), $(".blast-color").eq(a).on("click", function () {
   color = $(this).css("backgroundColor"), localStorage.setItem("my_custom_color", color), $(this).css("border", "2px solid black").siblings().css("border", "2px solid white")
  })
 }), $('input[name="blastCustomColor"]').on("change", function () {
  color = $(this).val(), localStorage.setItem("my_custom_color", color), setColor(color)
 }), $("*").on("click", function () {
  setColor(color)
 })
});
var color, my_custom_color = localStorage.getItem("my_custom_color");
